...
var u = new User("Shampa");
console.log(u.name);
function Logger2(prefix) {
    return function (constructor) {
        console.log("".concat(prefix, ": ").concat(constructor.name));
    };
}
var Product = function () {
    var _classDecorators = [Logger2("INFO")];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
...
var Order = function () {
    var _classDecorators = [AddCreatedAt];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var Order = _classThis = /** @class */ (function () {
        function Order_1(product) {

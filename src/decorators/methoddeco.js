...
function Log(prefix) {
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function () {
            ...
            console.log("".concat(prefix).concat(propertyKey, " called with"), args);
...
var User = function () {
    ...
    return _a = /** @class */ (function () {
            function User() {
                this._name = (__runInitializers(this, _instanceExtraInitializers), 'Murad');
            }

...
type BusinessPartner = Customer | Supplier;   //instanceof is used to check class / object type.
...
//function ta k amra "in" use kore likhte pari..sheta aro type safe hbe
